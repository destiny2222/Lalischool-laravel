    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('posts.update', $blogs->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="row">
                        ...
                        {{-- <div class="col-12 mb-3">
                            ...
                            <input type="text" value="{{ $blogs->tag->slug }}"  name="tag" class="form-control  @error('tag') is-invalid @enderror" id="basic-default-company" placeholder="" />
                            @error('tag')
                            <span class="invalid-feedback" role="alert">{{  $message  }}</span>
                            @enderror
                        </div> --}}
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea id="basic-default-message" id="body" name="body" class="form-control">{{ $blogs->body }}</textarea>
                        </div>
                    </div>
                    <div class="row g-2">
