...
<!-- Mirrored from preview.hasthemes.com/junior/event-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Aug 2022 14:40:08 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="x-ua-compatible" content="ie=edge">
	<title>Event Details || Junior Child Care & Shop HTML5 Template</title>
        				...
        				<div class="event-content-wrapper">
	        				...
	        				<div class="event-section">
	        					<div class="enent__thumb">
	        						<img src="images/event/big-img/1.jpg" alt="big images">
	        						<div class="box-timer">
	        					...
	        					<div class="event__inner">
	        						<span><i class="fa fa-calendar"></i>07 Oct, 2017</span>
	        						<h4>Lorem ipsusicing elit,Duis aute irureLorem ipsum dolor sitamet, consectetur adipisicing elit...</h4>

	        						<p>Loxcepteur sint  occaecat cupidatat non prdent, suntw in culpa qui officia deserunt mollit aLorem ipsum dolor sit amet, cadipisicinelit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ulaboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo </p>
	        				...
	        				<div class="event-section">
	        					<div class="event__advertise">
	        						<ul>
	        							<li>Duis aute irure dolor in reprehenderit in voluptat</li>
	        							<li>Duis aute irure dolor in reprehenderit in voluptat</li>
	        							<li>Duis aute irure dolor in reprehenderit in voluptat</li>
	        							<li>Excepteur sint occaecat cupidatat non proident</li>
	        							<li>dent, sunt in culpa qui officia des</li>
	        							<li>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sedd.</li>
	        							<li>Lorem ipsum dolor sit amet, consectetur adipisicing eli, sed do eiusmod tempor incididunt ut labmagna. Ut enim ad minim veniam, quis nostrud exercitation ullamlaboris nisi ut aliquip ex ea commodo conse aute imure dolor in reprehenderit in voluptate velit esse cil Gajan Mante lew</li>
	        						</ul>
	        						<div class="addver__thumb">
	        							<img src="images/event/big-img/2.jpg" alt="event images">
	        						</div>
	        					</div>
	        					<p>Loxcepteur sint  occaecat cupidatat non prdent, suntw in culpa qui officia deserunt mollit aLorem ipsum dolor sit amet, cadipisicinelit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ulaboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo </p>
        					</div>
	        				...
	        				<div class="event-section">
	        					...
	        					<div class="event__location">
	        						<ul>
	        							<li><span class="ti-user"></span>Colin Marks, Organizer <br> Head of the Department of engineering</li>
	        							<li><span class="ti-location-pin"></span>California Street san Francisco, CA</li>
        					...
        					<div class="upcoming__event mt--80">
        						...
        						<div class="row">
        							...
        							<div class="col-lg-6">
        								<!-- Start Event -->
										<div class="single__event d-flex bg__light__pink">
											<div class="event__thumb">
												<a href="event-details.html">
													<img src="images/event/sm-img/2.jpg" alt="event images">
												</a>
												<div class="event__hover__info">
													<span>16th May</span>
												</div>
        							...
        							<div class="col-lg-6">
										...
										<div class="single__event d-flex bg__light__green">
											<div class="event__thumb">
												<a href="event-details.html">
													<img src="images/event/sm-img/3.jpg" alt="event images">
												</a>
												<div class="event__hover__info">
													<span>16th Dec</span>
												</div>
        							...
        							<div class="col-lg-6">
										...
										<div class="single__event bg__baby__pink d-flex">
											...
											<div class="event__inner">
												<h6><a href="event-details.html">Drawing Competion</a></h6>
												<ul class="event__time__location">
													<li><i class="fa fa-home"></i>Childrens Club, Uttara, Dhaka</li>
													<li><i class="fa fa-clock-o"></i>5.00 am to 9.00 pm</li>
												</ul>
        				...
        				<div class="sidebar__widgets sidebar--right">
        					...
        					<div class="single__widget about">
								<div class="about__content">
									<img src="images/others/1.jpg" alt="about images">
									<div class="about__info">
										<div class="about__inner">
											<span>UI UX Designer</span>
											<h6>Easy Browdiliya</h6>
...
<!-- Mirrored from preview.hasthemes.com/junior/event-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Aug 2022 14:40:09 GMT -->
</html>
